...
| # | Result | Verdict |
|---|---|---|
| HC-135 | **NOT REACHED:** 135(a) Item 120 era question (per-calendar-week bucketing) — now slipped THREE rounds, remains the single most consequential open measurement (F-10). 135(b) Item 122 / C-2 attention key mapping — slipped SEVEN rounds. 135(c) Item 123 ATR asymmetry — correctly gated behind Item 131, which shipped this round, so it is now unblocked. 135(d) B-2/B-3/B-4/B-5, E-2, D-4 — not reached. | **NOT REACHED** |
